...
def find_tilt(img,angle_range=[1,2]):
	...
	for ang in np.arange(1,2,0.001):
		...
		r1 = np.mean(dst[400:500,:],axis=0)
		r2 = np.mean(dst[700:800,:],axis=0)
...
fl = '/home/phanindra/Python_Scripts/Abhilash/fixed_retarder-master/datasheets/optifcal_filters/450FS10.csv'
